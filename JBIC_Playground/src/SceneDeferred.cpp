...
SceneDeferred::SceneDeferred(App* app, const RenderParams& params)
...
void SceneDeferred::update(double delta)
{
	renderScene(delta);
}

void SceneDeferred::renderScene(double delta)
{
	geometryPass(delta);
	deferredShadingPass(delta);
}

void SceneDeferred::geometryPass(double delta)
{
	m_geoPass->use();
...
void SceneDeferred::deferredShadingPass(double delta)
{
...
void SceneDeferred::onKeyPressed(int key)
{
...
void SceneDeferred::onKeyReleased(int key)
{
